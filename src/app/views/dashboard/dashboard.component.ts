...
export class DashboardComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  // nodes: string[] = ["elsnas21.elsa.local", "elsnas22.elsa.local", "elsnas23.elsa.local"];
  constructor(
  ...
  ngAfterViewInit() {
    this.setBackgroundColor("#F7F8FA");
  }
  ngOnDestroy() {
    this.setBackgroundColor("#e4e5e6");
  }

  onChangeToRenewalPeriod() {}
  onChangeToTimeRange() {}
